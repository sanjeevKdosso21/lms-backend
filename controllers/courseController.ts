...
//     console.log('getting data form frontedd',req.body.name,req.body.mobile,req.body.email)
...
export const GetAllCourseList = async (req : Request, res : Response) =>{
  const create = await CourseTable.findAll();
  return res.send({message : 'course created ', data : create})
}